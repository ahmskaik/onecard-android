package com.nawasoft.oneapp.homefragment.adapter.companyadapter;
...
public class FeaturedCompanyListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FeaturedCompanyListAdapter(Context context, List<Company> companies, OnCompanyClickCallback callback) {
    ...
    class CompanyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Company company) {
            ...
            companyPhoto.setOnClickListener(view -> callback.onCompanyClick(getAdapterPosition()));
        }
